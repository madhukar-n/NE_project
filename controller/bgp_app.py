...
class RyuBGPSpeaker(RyuApp):
    ...
    def _add_neighbors(self, input):
        """
        Handled by the controller application, not by BGPSpeaker.
        """
        self.logger.info("Adding neighbors...as of now this is handled by the controller application, not by BGPSpeaker.")
